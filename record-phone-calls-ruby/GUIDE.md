...
Build a production-ready Sinatra application that initiates outbound calls and records them using the Telnyx Voice API.
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/record-phone-calls-ruby/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/record-phone-calls-ruby/API.md)
- [Voice API Documentation](https://developers.telnyx.com/docs/voice)
