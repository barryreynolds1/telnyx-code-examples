...
Record calls via webhook, then feed transcripts to AI for structured summaries: action items, decisions, sentiment, and call type classification.
...
| Inference | Summary and action item extraction |
