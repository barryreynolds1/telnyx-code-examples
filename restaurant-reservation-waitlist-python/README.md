...
| `HOST_SLACK_WEBHOOK` | `string` | `https://hooks.slack.com/...` | no | Slack webhook for host alerts | [→ link](https://api.slack.com/messaging/webhooks) |
...
Notifies customer that their service/table/order is ready via SMS.

**Request:**

```bash
curl -X POST http://localhost:5000/waitlist/0/ready
```
