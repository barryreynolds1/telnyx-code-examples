...
Build a production-ready Express application that initiates outbound calls and transfers them to another number using the Telnyx Voice API.
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/transfer-live-phone-calls-nodejs/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/transfer-live-phone-calls-nodejs/API.md)
- [Voice API Documentation](https://developers.telnyx.com/docs/voice)
