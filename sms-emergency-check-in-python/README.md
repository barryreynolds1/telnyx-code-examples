...
Periodic wellness checks via SMS. Send check-ins, track responses, escalate to emergency contacts after missed replies. SOS keyword triggers immediate alert.
...
| Product | Role |
|---------|------|
| SMS | Check-in messages and responses |
| Messaging Profiles | Automated check-in scheduling |
