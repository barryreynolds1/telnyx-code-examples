...
Automated first-round phone screening. AI interviews candidates with structured questions, records the call, and generates scored evaluations.
...
| Product | Role |
|---------|------|
| Voice API | Outbound screening calls + recording |
| Inference | Conversational interview + scoring |
