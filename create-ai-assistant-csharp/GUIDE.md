...
Build a production-ready ASP.NET endpoint that creates AI assistants using the Telnyx AI Assistants API.
...
```bash
curl -X POST http://localhost:5000create \
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/create-ai-assistant-csharp/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/create-ai-assistant-csharp/API.md)
- [AI Assistants Documentation](https://developers.telnyx.com/docs/ai)
