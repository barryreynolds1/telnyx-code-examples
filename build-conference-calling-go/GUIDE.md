...
Build a production-ready Gin web service that manages multi-participant conference calls using the Telnyx Voice API.
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/build-conference-calling-go/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/build-conference-calling-go/API.md)
- [Voice API Documentation](https://developers.telnyx.com/docs/voice)
