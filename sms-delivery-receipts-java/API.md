# API Reference — Delivery Receipts
...
```bash
curl -X POST http://localhost:5000/sms/delivery \
...
## `GET /sms/delivery/{messageId}`

Retrieve data from `/sms/delivery/{messageId}`.
