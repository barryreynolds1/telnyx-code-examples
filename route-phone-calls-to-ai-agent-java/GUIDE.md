...
Build a production-ready Spring Boot application that receives and processes inbound call webhooks from the Telnyx Voice API.
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/route-phone-calls-to-ai-agent-java/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/route-phone-calls-to-ai-agent-java/API.md)
- [Voice API Documentation](https://developers.telnyx.com/docs/voice)
