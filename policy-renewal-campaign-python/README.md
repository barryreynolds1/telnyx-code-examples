...
| `AGENT_SLACK_WEBHOOK` | string | `https://hooks.slack.com/services/...` | no | Slack webhook for agent alerts ([get it](https://api.slack.com/messaging/webhooks)) |
...
Events handled: `call.answered`, `call.speak.ended`, `call.gather.ended`, `call.gather.ended (DTMF)`
