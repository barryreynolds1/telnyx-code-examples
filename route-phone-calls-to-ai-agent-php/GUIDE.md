...
Build a production-ready Laravel application that receives and handles inbound call webhooks from the Telnyx Voice API.
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/route-phone-calls-to-ai-agent-php/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/route-phone-calls-to-ai-agent-php/API.md)
- [Voice API Documentation](https://developers.telnyx.com/docs/voice)
