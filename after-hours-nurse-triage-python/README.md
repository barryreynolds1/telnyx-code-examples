...
| `PAGERDUTY_ROUTING_KEY` | string | `uuid` | **yes** | PagerDuty Events API v2 routing key ([get it](PagerDuty > Services > Integrations)) |
| `NURSE_SLACK_WEBHOOK` | string | `https://hooks.slack.com/services/...` | no | Slack webhook for nurse alerts ([get it](https://api.slack.com/messaging/webhooks)) |
