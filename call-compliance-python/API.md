...
Retrieve data from `/compliance/records`.
...
## `GET /compliance/records/<call_control_id>`

Retrieve data from `/compliance/records/<call_control_id>`.
...
```bash
curl http://localhost:5000/compliance/records/<call_control_id>
```
