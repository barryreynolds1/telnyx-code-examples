...
Build a production-ready Spring Boot application that manages inbound SIP routing using the Telnyx Java SDK.
...
| `GET` | `/connections/{id}` | API endpoint |
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/inbound-sip-routing-java/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/inbound-sip-routing-java/API.md)
- [SIP Trunking Documentation](https://developers.telnyx.com/docs/sip-trunking)
