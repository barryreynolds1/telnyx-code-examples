...
Build a Flask application that tracks call metrics and provides analytics for your voice communications.
...
| `GET` | `/analytics/metrics` | API endpoint |
| `GET` | `/analytics/calls` | API endpoint |
...
```bash
curl http://localhost:5000/analytics/metrics
```
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/voice-call-analytics-python/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/voice-call-analytics-python/API.md)
- [Voice API Documentation](https://developers.telnyx.com/docs/voice)
