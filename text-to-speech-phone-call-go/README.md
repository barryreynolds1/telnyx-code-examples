...
import (
	...
	"github.com/team-telnyx/telnyx-go/v4/call"
)
...
- [Record Voice Calls with Go](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main//tutorials/voice/go/call-recording).
