...
Tenants call a maintenance line, AI triages the issue (emergency vs routine), collects unit and access info, generates work orders, and alerts managers for emergencies.
...
| Product | Role |
|---------|------|
| Voice API | Inbound maintenance calls |
| Inference | Issue triage and work order extraction |
