...
Build a production-ready Laravel application that initiates outbound calls and records them using the Telnyx Voice API.
...
| `POST` | `/calls/recording/start` | API endpoint |
| `POST` | `/calls/recording/stop` | API endpoint |
| `POST` | `/calls/hangup` | API endpoint |
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/record-phone-calls-php/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/record-phone-calls-php/API.md)
- [Voice API Documentation](https://developers.telnyx.com/docs/voice)
