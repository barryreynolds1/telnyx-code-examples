...
## `GET /sim-cards/:id/usage`

Retrieve data from `/sim-cards/:id/usage`.
...
```bash
curl http://localhost:5000/sim-cards/:id/usage
```
...
Retrieve data from `/dashboard/usage`.
...
```bash
curl http://localhost:5000/dashboard/usage
```
