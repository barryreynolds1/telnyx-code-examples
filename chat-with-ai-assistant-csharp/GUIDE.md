...
Build a production-ready ASP.NET Core endpoint that enables real-time chat interactions with a Telnyx AI Assistant.
...
| `TELNYX_AI_ASSISTANT_ID` | your_telnyx_ai_assistant_id_here |
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/chat-with-ai-assistant-csharp/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/chat-with-ai-assistant-csharp/API.md)
- [AI Assistants Documentation](https://developers.telnyx.com/docs/ai)
