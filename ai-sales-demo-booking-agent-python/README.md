...
Inbound sales calls handled by AI. Qualifies the lead (company size, timeline, current solution), scores fit, and books a demo slot.
...
| Product | Role |
|---------|------|
| Voice API | Inbound sales calls |
| Inference | Lead qualification + data extraction |
