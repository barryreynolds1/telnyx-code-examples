...
Incoming call triggers a caller lookup, dials the agent, whispers caller info (name, company, tier, open tickets) before connecting.
...
| Product | Role |
|---------|------|
| Voice API | Call bridging and whisper |
| Number Lookup | Caller identification |
| Call Control | Multi-leg call management |
