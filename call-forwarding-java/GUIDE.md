...
Build a production-ready Spring Boot application that implements intelligent call forwarding using the Telnyx Voice API.
...
| `POST` | `/{callControlId}/transfer` | API endpoint |
| `POST` | `/{callControlId}/hangup` | API endpoint |
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/call-forwarding-java/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/call-forwarding-java/API.md)
- [Voice API Documentation](https://developers.telnyx.com/docs/voice)
