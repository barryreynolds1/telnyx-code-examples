...
Build a production-ready Laravel application that plays text-to-speech (TTS) messages during voice calls using the Telnyx Voice API.
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/text-to-speech-phone-call-php/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/text-to-speech-phone-call-php/API.md)
- [Messaging Documentation](https://developers.telnyx.com/docs/messaging)
