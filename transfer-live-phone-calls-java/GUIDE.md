...
Build a production-ready Spring Boot application that initiates calls and transfers them to another number using the Telnyx Voice API.
...
- [Source code](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/transfer-live-phone-calls-java/README.md)
- [API reference](https://raw.githubusercontent.com/team-telnyx/telnyx-code-examples/main/transfer-live-phone-calls-java/API.md)
- [Voice API Documentation](https://developers.telnyx.com/docs/voice)
