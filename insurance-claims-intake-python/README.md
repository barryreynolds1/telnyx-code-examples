...
| `ADJUSTER_SLACK_WEBHOOK` | `string` | `https://hooks.slack.com/...` | no | Slack webhook for adjuster alerts | [→ link](https://api.slack.com/messaging/webhooks) |
...
```bash
curl -X POST http://localhost:5000/claims/CLM-1001/assign \
